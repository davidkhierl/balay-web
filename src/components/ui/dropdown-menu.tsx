...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors focus:bg-violet-100 focus:text-violet-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-violet-800 dark:focus:text-violet-50',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-1 h-px bg-violet-100 dark:bg-violet-800', className)}
    {...props}
  />
))
